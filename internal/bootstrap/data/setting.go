...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		// style settings
		{Key: conf.Logo, Value: "https://li-peifeng.github.io/isweet/logo.png?v=88", Type: conf.TypeText, Group: model.STYLE},
		{Key: conf.Favicon, Value: "https://li-peifeng.github.io/isweet/favicon.ico?v=88", Type: conf.TypeString, Group: model.STYLE},
	...
	"epub": {
		...
		//}`, Type: conf.TypeText, Group: model.PREVIEW},
		{Key: "audio_cover", Value: "https://li-peifeng.github.io/isweet/audio.png?v=88", Type: conf.TypeString, Group: model.PREVIEW},
