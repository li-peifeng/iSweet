...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		// style settings
		{Key: conf.Logo, Value: "https://cdn.jsdelivr.net/gh/li-peifeng/cdn/logo.png", Type: conf.TypeText, Group: model.STYLE},
		{Key: conf.Favicon, Value: "https://cdn.jsdelivr.net/gh/li-peifeng/cdn/favicon.ico", Type: conf.TypeString, Group: model.STYLE},
	...
	"epub": {
		...
		//}`, Type: conf.TypeText, Group: model.PREVIEW},
		{Key: "audio_cover", Value: "https://cdn.jsdelivr.net/gh/li-peifeng/cdn/isweet/audio.png", Type: conf.TypeString, Group: model.PREVIEW},
