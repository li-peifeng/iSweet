...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		{Key: conf.SiteTitle, Value: "iSweet.Cloud", Type: conf.TypeString, Group: model.SITE},
		{Key: conf.Announcement, Value: "#### Welcome To iSweet.Cloud", Type: conf.TypeText, Group: model.SITE},
		...
		// style settings
		{Key: conf.Logo, Value: "https://cdn.jsdelivr.net/gh/li-peifeng/static/logo.png", Type: conf.TypeText, Group: model.STYLE},
		{Key: conf.Favicon, Value: "https://cdn.jsdelivr.net/gh/li-peifeng/static/favicon.ico", Type: conf.TypeString, Group: model.STYLE},
	...
	"epub": {
		...
		//}`, Type: conf.TypeText, Group: model.PREVIEW},
		{Key: "audio_cover", Value: "https://cdn.jsdelivr.net/gh/li-peifeng/static/isweet/audio.png", Type: conf.TypeString, Group: model.PREVIEW},
