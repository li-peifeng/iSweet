...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		// style settings
		{Key: conf.Logo, Value: "https://is.peifeng.li/isweet/logo.png", Type: conf.TypeText, Group: model.STYLE},
		{Key: conf.Favicon, Value: "https://is.peifeng.li/isweet/favicon.ico", Type: conf.TypeString, Group: model.STYLE},
	...
	"epub": {
		...
		//}`, Type: conf.TypeText, Group: model.PREVIEW},
		{Key: "audio_cover", Value: "https://is.peifeng.li/isweet/audio.png", Type: conf.TypeString, Group: model.PREVIEW},
